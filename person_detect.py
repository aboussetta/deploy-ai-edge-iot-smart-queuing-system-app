...
class PersonDetect:
    ...
    def __init__(self, model_name, device, threshold=0.60):
        ...
        try:
            ...
            #self.model=self.plugin.read_network(model=self.model_structure, weights=self.model_weights)
    ...
    def load_model(self):
        ...
        self.network = plugin.load_network(self.model, self.device)
    ...
    def predict(self, image):
        ...
        TODO: This method needs to be completed by you
        '''
        in_frame = self.preprocess_input(image)
        infer_request_handle = self.network.start_async(request_id=0, inputs=in_frame)
